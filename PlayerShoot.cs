    ...
    void Update()
    {
        ...
        if (canShoot)
        {
            ...
            else
            {
                ...
                if (Input.GetButton("LB_1") || Input.GetButton("A_1") || Input.GetButton("B_1"))
                {
                    if (holdTime <= 15f)
                    {
                        holdTime += Time.deltaTime * holdTimeModifier;
                ...
                else if (Input.GetButtonUp("LB_1") && holdTime > 0 || Input.GetButtonUp("A_1") && holdTime > 0 || Input.GetButtonUp("B_1") && holdTime > 0)
                {
                    SecondaryShoot();
                }
            }
